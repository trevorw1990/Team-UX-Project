...
export default function InboxMessages({ user, setUser, pageToShow,  setPageToShow, params, receiverId, setReceiverId, setTheMessage, createNewThread, allMessages, messageToShow, setMessageToShow }) {
    ...
    const pageNavigator = () => {
        if (pageToShow === 'InboxMessages') {
            ...
            return <InboxAllMail user={ user } setUser={ setUser } allMessages={allMessages} setPageToShow={setPageToShow} messageToShow={messageToShow} setMessageToShow={setMessageToShow} />
            ...
            return <InboxShowMessage user={ user } setUser={ setUser } pageToShow={pageToShow} setPageToShow={setPageToShow} messageToShow={messageToShow} setMessageToShow={setMessageToShow} />
        }
    }
    useEffect(() => {
